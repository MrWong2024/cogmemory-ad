...
- A29 / A30 后端范围完成，父实例 + 固定题目 scope 的可恢复 submission write barrier 已关闭相邻生命周期写保护 gap；frontend reconciliation single-flight 与 P3 回归已关闭，B18 补充验证仅余 P9 Browser 测试资产/验收 `gap=1`，WP-03 进行中。
