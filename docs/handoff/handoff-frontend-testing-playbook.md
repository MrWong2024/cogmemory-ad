...
| Batch C / B7–B10 | B7、B8 与 B9 已完成；B10-A fixture 与 B10-B4 测试资产修复已完成；B10-B 未完成 | `generation-workflow` 当前为 44 pass / 0 fail / 4 not_executed / 0 obsolete；下一阶段使用全新 namespace 完整重跑；`public-surface-security` 尚未启动 |
