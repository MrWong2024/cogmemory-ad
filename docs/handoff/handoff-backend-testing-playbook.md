...
本文档不改变产品、接口、DTO、Schema、测试合同或 roadmap 工作包状态。当前唯一事实是：WP-02、WP-04、Batch A 已完成；Batch B 桌面范围已完成；Batch C 的 B7、B8 与 B9 已完成，B9 最终为 51 active pass + B9-32 obsolete。B10-A fixture 与分批验收合同已完成；B10-B `generation-workflow` 的 48 项已全部通过，B10-B 已完成；B10 整体仍未完成，下一阶段为 `public-surface-security`，Batch D 尚未启动；Batch E 的 8 项真实设备、辅助技术或人工验收继续保留。
...
| Batch C / B7–B10 | B7、B8 与 B9 已完成；B10-A fixture、B10-B4 测试资产修复与 B10-B `generation-workflow` 已完成；B10 整体仍未完成 | `generation-workflow` 为 48 pass / 0 fail / 0 not_executed / 0 obsolete；下一阶段为 `public-surface-security`；Batch D 尚未启动 |
...
| Batch C / B10 | `scripts/b10-browser-fixtures.ts` | 两个独立 profile；每个 5 角色；`generation-workflow` 10 scenarioKey / 26 route / 48 audit ID，`public-surface-security` 13 scenarioKey / 21 route / 47 audit ID | B10-B `generation-workflow` 48 项全部通过且已完成；B10 整体仍未完成，下一阶段为 `public-surface-security` |
