...
| Batch D / B11–B15 | B11 已完成；B12-B2 完整重跑存在 Playwright 资产阻断；Batch D 尚未完成 | 22 条 core route 均实际执行但最终均失败，62 个 core Browser ID 未关闭；post-browser verify 与双 cleanup 通过；B12-B、B12 与 Batch D 未完成，不进入 B12-C，B12-86–B12-88 未关闭 |
