...
- 当前存在 health controller spec、Storage service spec、上传文件名工具 spec、scales service / schema spec、patients service / schema spec、assessments service / schema spec、media service / schema spec、scoring service / schema spec 和 cognitive-domains service / schema spec。
- 后端默认端口为 `5002`。
