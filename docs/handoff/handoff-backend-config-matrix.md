...
| `OSS_OBJECT_PREFIX` | `storage.oss.objectPrefix` | `cogmemory_ad/development` | `cogmemory_ad/production` | `cogmemory_ad` | environment-specific example；test 保持 fake storage 当前口径 |
